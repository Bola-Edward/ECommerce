...
{
    public sealed class HybridCacheAggregateStore<T>(HybridCache cache, IOptionsMonitor<CacheEntryPolicy> optionsMonitor) : ICachedAggregateStore<T> where T : class
    {
