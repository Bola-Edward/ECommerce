    ...
    public static class BasketErrors
    {
        ...
        public static readonly Error InvalidQuantity =
            Error.Validation(
                ...
                $"Quantity must be between {BasketItemEntity.MinQuantity} and {BasketItemEntity.MaxQuantity}.");
        ...
        public static readonly Error QuantityTooHigh =
            Error.Validation(
                ...
                $"Total quantity for a product cannot exceed {BasketItemEntity.MaxQuantity}.");
